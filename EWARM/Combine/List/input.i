...
uint8_t input_flags[18];
uint16_t input_timers[18];
extern uint16_t waterTimer;     
extern uint16_t waterTimer1;     
extern uint16_t waterTimer2;     
extern uint16_t waterTimer3;     
extern uint16_t waterTimer4;     
...
{ 
    ...
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),        
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),         
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),
    ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)),
...
void input_init()
{
  ...
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), &GPIO_InitStructure);     
 ...
 uint8_t read_tail_light()
{
  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x4000)) == GPIO_PIN_SET)
    return 0;                                                           
  else               
    return 1;
}
...
void read_inputs()
{
  ...
  flagInput.tailLamp = (input_flags[3] == 0) ? 0 : 1;
  flagInput.charge = (input_flags[2] == 0) ? 0 : 1; 
  ...
  flagInput.bon_2 = (input_flags[11] == 0) ? 0 : 1;  
  flagInput.pre_heating = (input_flags[12] == 0) ? 0 : 1;   
  flagInput.diode = (input_flags[13] == 1) ? 0 : 1;
  flagInput.dfp = (input_flags[14] == 0) ? 0 : 1;
  flagInput.miding = (input_flags[15] == 0) ? 0 : 1;
  flagInput.chippechul = (input_flags[16] == 0) ? 0 : 1;
  flagInput.mulpulli = (input_flags[17] == 1) ? 0 : 1;
  
  if(flagInput.waterTemperature == 0)
      waterTimer = 0;
  if(flagInput.bon_2 == 0)
      waterTimer2 = 0;
  if(flagInput.oilPressure == 0)
      waterTimer4 = 0;
  if(tFuelPercent > 1)
      waterTimer1 = 0;
  if(flagInput.tailLamp == 0)
      waterTimer3 = 0;
  if(flagInput.charge == 0)
      waterTimer5 = 0;
  if(flagInput.diode == 0)
      waterTimer6 = 0;
  if(flagInput.dfp == 0)
      waterTimer7 = 0;
  if(flagInput.grain_4 == 0)
      waterTimer8 = 0;
  if(flagInput.chippechul == 0)
      waterTimer9 = 0;
  if(flagInput.pre_heating == 0)
      waterTimer10 = 0;
  if(flagInput.mulpulli == 0)
      waterTimer11 = 0;
