...
GPIO_TypeDef*   BTN_PORTS[4] = {((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)) };
uint16_t        BTN_PINS[4]  = {((uint16_t)0x0040), ((uint16_t)0x0020), ((uint16_t)0x0010), ((uint16_t)0x0008) };

uint8_t btnState[4];
uint8_t btnFlags[4];
uint16_t btnTimers[4];

uint8_t prevBtnState[4];
...
void check_buttons(void)
{
  ...
  for(i = 0 ; i < 4; i++)
  {
    ...
    if(HAL_GPIO_ReadPin(BTN_PORTS[i], BTN_PINS[i]) == GPIO_PIN_SET)             
    {
      btnTimers[i] = 0;
    }
    ...
    if((btnState[i] == 1) && (prevBtnState[i] == 0))       
    {
