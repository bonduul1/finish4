...
uint16_t waterTimer =0; 
uint16_t waterTimer1 =0; 
uint16_t waterTimer2 =0; 
uint16_t waterTimer3 =0; 
uint16_t waterTimer4 =0; 
...
uint16_t draw_main_page(uint16_t _imgCnt)
{
  ...
  else if (flagInput.waterTemperature && waterTimer < 5000) 
  {
    waterTimer+=100; 
    YVC1_SetSprtAttr(imgCnt++, (const T_Y643_LYR_SPRTATTR *)MAIN_GT[yusu]);
    set_warning_sound(0xFFFF, 1000, 1000, 3);
    if (((waterTimer) > (500) && (waterTimer) < (1000)) || ((waterTimer) > (1500) && (waterTimer) < (2000)) || ((waterTimer) > (2500) && (waterTimer) < (3000)) || ((waterTimer) > (3500) && (waterTimer) < (4000)) || ((waterTimer) > (4500) && (waterTimer) < (5300))){
         sound_clear(0x01);
      }
    }
  else if (flagInput.bon_2 && waterTimer2 < 5000)
    {
      ...
      set_warning_sound(0xFFFF, 1000, 1000, 3);
      if (((waterTimer2) > (500) && (waterTimer2) < (5100))){
       sound_clear(0x01);
    }
    }
  else if (tFuelPercent < 2 && waterTimer1 < 5000) 
  {
    waterTimer1+=100; 
    YVC1_SetSprtAttr(imgCnt++, (const T_Y643_LYR_SPRTATTR *)MAIN_GT[preheating]);
    set_warning_sound(0xFFFF, 1000, 1000, 3);
    if (((waterTimer1) > (1000) && (waterTimer1) < (2000)) || ((waterTimer1) > (3000) && (waterTimer1) < (4000))){
       sound_clear(0x01);
    }
    }                               
  else if (flagInput.tailLamp && waterTimer3 < 5000)
  {
    ...
    set_warning_sound(0xFFFF, 1000, 1000, 3);
    if (((waterTimer3) > (500) && (waterTimer3) < (5100))){
       sound_clear(0x01);
    }
  }

  else if (flagInput.oilPressure == 0x01 && waterTimer4 < 5000 && engine_speed > 500)
  {
    waterTimer4 += 100;
    YVC1_SetSprtAttr(imgCnt++, (const T_Y643_LYR_SPRTATTR *)MAIN_GT[engineOil]);
    set_warning_sound(0xFFFF, 1000, 1000, 3);
    if (((waterTimer4) > (1000) && (waterTimer4) < (2000)) || ((waterTimer4) > (3000) && (waterTimer4) < (4000)))
    {
       sound_clear(0x01);
    }
  }
  ...
  else if (flagInput.charge && waterTimer5 < 5000 && engine_speed > 500)              
  {
        ...
        set_warning_sound(0xFFFF, 1000, 1000, 3);
       if (((waterTimer5) > (1000) && (waterTimer5) < (2000))|| ((waterTimer5) > (3000) && (waterTimer5) < (4000))){
        sound_clear(0x01);
    }
   }
    else if (flagInput.diode && waterTimer6 < 10000 )              
  {
        ...
        set_warning_sound(0xFFFF, 1000, 1000, 3);
       if (((waterTimer6) > (1000) && (waterTimer6) < (2000)) || ((waterTimer6) > (3000) && (waterTimer6) < (4000)) || ((waterTimer6) > (5000) && (waterTimer6) < (6000))  || ((waterTimer6) > (7000) && (waterTimer6) < (8000))  || ((waterTimer6) > (9000) && (waterTimer6) < (10300))){
        sound_clear(0x01);
    }
   } 
      else if (flagInput.dfp && waterTimer7 < 5000 )              
  {
        ...
        set_warning_sound(0xFFFF, 1000, 1000, 3);
       if (((waterTimer7) > (1000) && (waterTimer7) < (2000)) || ((waterTimer7) > (3000) && (waterTimer7) < (4000))){
        sound_clear(0x01);
    }
   }
    ...
    set_warning_sound(0xFFFF, 1000, 1000, 3);
    if (((waterTimer8) > (1000) && (waterTimer8) < (2000)) || ((waterTimer8) > (3000) && (waterTimer8) < (5100))){
        sound_clear(0x01);
    }
    }
    ...
    YVC1_SetSprtAttr(imgCnt++, (const T_Y643_LYR_SPRTATTR *)MAIN_GT[mulpulli]);
       set_warning_sound(0xFFFF, 1000, 1000, 3);
       if (((waterTimer11) > (1000) && (waterTimer11) < (5100))){
        sound_clear(0x01);
       }
    }      
...
void analog_sensors()
{
  ...
  if(flagTimer.hundredMs == 0x01)                                                  
  {
    ...
    {
      tFuelPercent = (uint8_t)(tFuelPercentTotal / (float)100);  
    }
...
void sensor_process()
{
  ...
  if(flagTimer.hundredMs == 0x01)
  {
     if(flagInput.miding == 0x01)
    {
      update_timer(lcdBrigthnessNight);
    }
    else if(flagInput.miding == 0x00)
    {
      prevTaillamp += 10;
      if(prevTaillamp == 60){
      prevTaillamp = 0;
